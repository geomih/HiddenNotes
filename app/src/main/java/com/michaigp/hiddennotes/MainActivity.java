...
public class MainActivity extends AppCompatActivity
    ...
    @BindView(R.id.appBarLayout) Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Glide.with(this).load("https://www.android.com/static/2016/img/hero-carousel/android-nougat.png").asBitmap().into(imageView);
